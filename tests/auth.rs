...
use polymarket_client_sdk::auth::builder;
use polymarket_client_sdk::auth::state::Authenticated;
use polymarket_client_sdk::auth::{Credentials, Normal, PrivateKeySigner, Signer as _, l1, l2};
use polymarket_client_sdk::clob::types::{Order, new_order};
use polymarket_client_sdk::clob::types::{Side, SignatureTypeV2, sign_order, signing_hash};
use polymarket_client_sdk::clob::{Client, Config};
use polymarket_client_sdk::{AMOY, POLYGON, config};
use reqwest::Method;
